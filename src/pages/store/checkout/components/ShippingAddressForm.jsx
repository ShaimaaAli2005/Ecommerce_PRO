      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
        <div className="space-y-1.5">
          <label className="font-bold text-slate-700 dark:text-gray-300">
            {t('store.checkout.fullname', 'Full Name *')}
          </label>
          <input
            type="text"
            name="fullName"
        ...
        <div className="space-y-1.5">
          <label className="font-bold text-slate-700 dark:text-gray-300">
            {t('store.checkout.phone', 'Phone Number *')}
          </label>
          <input
            type="text"
            name="phone"
        ...
        <div className="space-y-1.5">
          <label className="font-bold text-slate-700 dark:text-gray-300">
            {t('store.checkout.country', 'Country *')}
          </label>
          <input
            type="text"
            name="country"
        ...
        <div className="sm:col-span-2 space-y-1.5">
          <label className="font-bold text-slate-700 dark:text-gray-300">
            {t('store.checkout.address', 'Street Address *')}
          </label>
          <input
            type="text"
            name="address"
        ...
        <div className="space-y-1.5">
          <label className="font-bold text-slate-700 dark:text-gray-300">
            {t('store.checkout.postal_code', 'Postal Code')}
          </label>
          <input
            type="text"
            name="postalCode"
        ...
        <div className="sm:col-span-2 space-y-1.5">
          <label className="font-bold text-slate-700 dark:text-gray-300">
            {t('store.checkout.note', 'Order Notes (Optional)')}
          </label>
          <textarea
            name="customerNote"
